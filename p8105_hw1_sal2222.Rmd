...
ggplot(five_variable_df, aes(x = x, y = y, color = logical_sum_xy)) + geom_point()
...
ggplot(five_variable_df, aes(x = x, y = y, color = numeric_from_logical)) + geom_point()
...
ggplot(five_variable_df, aes(x = x, y = y, color = factor_from_logical)) + geom_point()
